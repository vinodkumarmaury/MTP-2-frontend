  ...
  const steps = [
    ...
    },
    {
      ...
      params: [
        ...
        'Governance (NEW v3.0): 0.25×ISO45001 + 0.20×ISO14001 + 0.20×Violations + 0.15×ESG + 0.12×DGMS + 0.08×Audit',
        'Risk (v3.0): 0.17×FoS + 0.14×POF + 0.13×ExpLoss + 0.12×CPT + 0.08×Methane + 0.06×Lease + 0.04×Litigation + 0.09×NearMiss + 0.04×Fire + 0.04×BenchHeight + 0.02×HaulRoad + 0.03×DewaterRisk',
      ],
    },
    {
      n: '3',
