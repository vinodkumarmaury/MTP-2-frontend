...
export const CORE_SECTIONS: SectionDef[] = [
  { id:'eco', label:'Economic', color:'#1D9E75', icon:'₹', fields:[
    {k:'npv_cr',              label:'Net Present Value',              unit:'₹ Crore',         type:'number'},
    {k:'irr_pct',             label:'Internal Rate of Return',        unit:'%',               type:'number'},
    ...
    {k:'sustaining_capex_cr', label:'Sustaining CAPEX',               unit:'₹ Cr/yr',         type:'number'},
    {k:'opex_per_tonne',      label:'Operating Cost per Tonne',       unit:'₹/t',             type:'number'},
    ...
    {k:'wacc_pct',            label:'Weighted Avg. Cost of Capital',  unit:'%',               type:'number'},
    ...
    {k:'debt_equity_ratio',   label:'Debt-to-Equity Ratio',           unit:'D/E',             type:'number', help:'Financial leverage — lower is better (0 = all equity)'},
  ...
  { id:'geo', label:'Geological', color:'#534AB7', icon:'⛏', fields:[
    ...
    {k:'gcv_blended',         label:'Blended GCV',                    unit:'kcal/kg',         type:'number', help:'Grade A(>6700), B(6201-6700), C(5601-6200), D(4941-5600), E(4201-4940), F(3361-4200), G(≤3360)'},
  ...
  { id:'env', label:'Environmental', color:'#3B6D11', icon:'🌿', fields:[
    ...
    {k:'ob_dump_fos',         label:'OB Dump Factor of Safety',       unit:'—',               type:'number'},
    {k:'backfill_ratio',      label:'Progressive Backfilling Ratio',  unit:'%',               type:'number'},
    {k:'ghg_scope1_tco2yr',   label:'GHG Scope 1 Emissions',          unit:'tCO₂e/yr',        type:'number'},
    {k:'ghg_scope2_tco2yr',   label:'GHG Scope 2 Emissions',          unit:'tCO₂e/yr',        type:'number'},
    {k:'ghg_intensity',       label:'GHG Intensity (Scope 1+2)',      unit:'tCO₂e/t',         type:'number'},
  ...
  { id:'soc', label:'Social', color:'#BA7517', icon:'👥', fields:[
    {k:'ltifr',               label:'Lost Time Injury Frequency Rate', unit:'per 10⁶ man-hrs', type:'number'},
    {k:'far',                 label:'Fatal Accident Rate',             unit:'per 10⁸ man-hrs', type:'number'},
    ...
    {k:'rr_cost_cr',          label:'R&R Cost (RFCTLARR)',              unit:'₹ Crore',         type:'number'},
    {k:'csr_spend_cr',        label:'CSR Mandatory Spend',              unit:'₹ Cr/yr',         type:'number'},
    ...
    {k:'contractor_ltifr',    label:'Contractor LTIFR',                unit:'per 10⁶ man-hrs', type:'number', help:'LTIFR for contract workers (usually higher than direct)'},
  ]},
  ...
  { id:'risk', label:'Risk', color:'#A32D2D', icon:'⚠', fields:[
    {k:'slope_fos_mean',      label:'Slope FoS (mean)',               unit:'—',               type:'number'},
    {k:'slope_fos_sd',        label:'Slope FoS (std deviation σ)',    unit:'—',               type:'number'},
    {k:'prob_of_failure_pct', label:'Probability of Failure (Monte Carlo)', unit:'%',         type:'number'},
    ...
    {k:'dgms_compliance_pct', label:'DGMS Audit Compliance Score',    unit:'%',               type:'number', help:'% compliance in DGMS safety audit (CIL avg ~75%)'},
  ]},
  { id:'gov', label:'Governance', color:'#6B48C4', icon:'🏛', fields:[
    {k:'iso_14001',           label:'ISO 14001 Certification',         unit:'',               type:'select', opts:['Certified','In Progress','Not Started'], help:'Environmental Management System certification'},
    {k:'iso_45001',           label:'ISO 45001 Certification',         unit:'',               type:'select', opts:['Certified','In Progress','Not Started'], help:'Occupational Health & Safety Management System certification'},
    ...
    {k:'esg_disclosure_score',label:'ESG Disclosure Quality Score',    unit:'0-100',          type:'number', help:'Quality of ESG reporting and transparency (0=no reporting, 100=best-in-class)'},
...
export const SUBTOPIC_SECTIONS: SectionDef[] = [
  { id:'minelife', label:'Mine Life', color:'#185FA5', icon:'⏱', fields:[
    {k:'reserve_mt',          label:'Mineable Coal Reserve',          unit:'Mt',              type:'number'},
    {k:'annual_prod_mty',     label:'Annual Production Rate',         unit:'MTY',             type:'number'},
  ...
  { id:'hemm', label:'HEMM & Cost', color:'#185FA5', icon:'🚛', fields:[
    ...
    {k:'shovel_output_bcmhr', label:'Shovel Output Rate',             unit:'BCM/hr',          type:'number'},
    ...
    {k:'capex_cr',            label:'Total HEMM + Civil CAPEX',       unit:'₹ Crore',         type:'number'},
    {k:'opex_per_tonne',      label:'OPEX (all-in per tonne)',         unit:'₹/tonne',         type:'number'},
    {k:'ob_mining_cost',      label:'OB Mining Cost',                 unit:'₹/BCM',           type:'number'},
  ...
  { id:'sr', label:'Stripping Ratio', color:'#185FA5', icon:'📐', fields:[
    {k:'stripping_ratio_instantaneous', label:'Instantaneous Stripping Ratio', unit:'BCM:t', type:'number'},
    {k:'stripping_ratio_overall', label:'Overall Stripping Ratio',     unit:'BCM:t',          type:'number'},
    {k:'besr',                label:'Break-Even Stripping Ratio',     unit:'BCM:t',           type:'number'},
  ...
  { id:'coal', label:'Coal Quality', color:'#534AB7', icon:'🔬', fields:[
    {k:'gcv_seamwise',        label:'GCV — Seam-wise',                unit:'kcal/kg',         type:'number'},
    {k:'gcv_blended',         label:'Blended GCV (weighted avg)',     unit:'kcal/kg',         type:'number', help:'CIL Grade: A(>6700), B(6201-6700), C(5601-6200), D(4941-5600), E(4201-4940), F(3361-4200), G(≤3360)'},
    {k:'ash_pct',             label:'Ash Content',                   unit:'%',                type:'number'},
    ...
    {k:'cpt_deg',             label:'Crossing Point Temperature',    unit:'°C',               type:'number', help:'Spontaneous combustion index: <140°C = high risk'},
  ]},
  { id:'blast', label:'Bench & Blast', color:'#185FA5', icon:'💥', fields:[
    {k:'bench_height_ob_m',   label:'OB Bench Height',               unit:'m',                type:'number'},
